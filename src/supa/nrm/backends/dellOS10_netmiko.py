...
class Backend(BaseBackend):
    ...
    def __init__(self) -> None:
        """Load properties from 'dellOS10_netmiko.env'."""
    ...
    def activate(
        ...
        """Activate resources."""
        self.log.info(
            "Activate resources in dellOS10_netmiko NRM", backend=self.__module__, primitive="activate", connection_id=str(connection_id)
        )
    ...
    def deactivate(
        ...
        self.log.info(
            "Deactivate resources in dellOS10_netmiko NRM", backend=self.__module__, primitive="deactivate", connection_id=str(connection_id)
        )
    ...
    def topology(self) -> List[STP]:
        ...
        self.log.info("get topology from dellOS10_netmiko NRM", backend=self.__module__, primitive="topology")
...
### Not implemented functions, just provide logging. ###
    ...
    def reserve(
        ...
        self.log.info(
            "Reserve resources in dellOS10_netmiko NRM", backend=self.__module__, primitive="reserve", connection_id=str(connection_id)
        )
        return None
    ...
    def reserve_timeout(
        ...
        self.log.info(
            "Reserve timeout resources in dellOS10_netmiko NRM",
    ...
    def reserve_commit(
        ...
        self.log.info(
            "Reserve commit resources in dellOS10_netmiko NRM",
            backend=self.__module__,
    ...
    def reserve_abort(
        ...
        self.log.info(
            "Reserve abort resources in dellOS10_netmiko NRM",
            backend=self.__module__,
    ...
    def provision(
        ...
        self.log.info(
            "Provision resources in dellOS10_netmiko NRM", backend=self.__module__, primitive="provision", connection_id=str(connection_id)
        )
        return None
    ...
    def release(
        ...
        self.log.info(
            "Release resources in dellOS10_netmiko NRM", backend=self.__module__, primitive="release", connection_id=str(connection_id)
        )
        return None
